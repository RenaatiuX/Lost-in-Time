...
public class Tepexichthys extends WaterMobEntity implements IAnimatable, IAnimationTickable {
    private static final DataParameter<Boolean> FROM_BUCKET = EntityDataManager.createKey(Tepexichthys.class, DataSerializers.BOOLEAN);
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public Tepexichthys(EntityType<Tepexichthys> type, World worldIn) {
        super(type, worldIn);
        this.moveController = new AquaticMoveController(this, 1.0F);
    }

    public Tepexichthys(World world) {
        super(EntityInit.TEPEXICHTHYS.get(), world);
    }
    ...
    public ItemStack getFishBucket() {
        return new ItemStack(ItemInit.TEPEXICHTHYS_BUCKET.get());
    }
