...
public class DecayedHypsocormus extends WaterMobEntity implements IAnimatable, IAnimationTickable {
    private static final DataParameter<Boolean> FROM_BUCKET = EntityDataManager.createKey(DecayedHypsocormus.class, DataSerializers.BOOLEAN);
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public DecayedHypsocormus(EntityType<? extends WaterMobEntity> type, World p_i48565_2_) {
        super(type, p_i48565_2_);
        this.moveController = new AquaticMoveController(this, 1.0F);
    }

    public DecayedHypsocormus(World world) {
        super(EntityInit.DECAYED_HYPSOCORMUS.get(), world);
    }
